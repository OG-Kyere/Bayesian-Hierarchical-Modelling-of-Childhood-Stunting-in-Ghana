...
\author{Kyere Ofosu Gideon, BSc\\\small Independent Researcher, Ghana}
\date{}
\begin{document}
\maketitle
...
OpenAI ChatGPT (GPT-5.6 Sol; accessed September 2026) was used to assist with language editing, manuscript organization, code drafting and review, and reproducibility documentation. The author reviewed and revised the manuscript text, checked analysis code and reported numerical results against the saved outputs, and remains responsible for the accuracy and integrity of the work.
