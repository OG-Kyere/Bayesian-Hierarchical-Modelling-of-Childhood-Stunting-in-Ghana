...
This was a cross-sectional secondary analysis of the Household Member Recode from the 2022 GDHS, accessed under authorization from The DHS Program. The GDHS used a stratified two-stage cluster sample \citep{GSSICF2024}. Children were eligible for this analysis if they were aged 0--59 months, had slept in the sampled household on the night before the interview (\texttt{hv103 = yes}), and had a valid height-for-age z-score in \texttt{hc70}.
