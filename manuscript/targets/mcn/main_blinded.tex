...
\begin{itemize}
\item Most residual clustering in childhood stunting occurred between households rather than between survey communities.
\item The household component remained large after adjustment for socioeconomic characteristics, WASH, and maternal education.
\item Surface-water use accounted for the clearest signal in the detailed drinking-water sensitivity analysis.
\item Higher maternal education and household wealth were associated with lower odds of stunting.
\item The main conclusions changed little across alternative age, prior, WASH, and missing-data specifications.
\end{itemize}
...
Finally, PSIS-LOO did not distinguish the harmonized WASH and maternal-education models in a practically meaningful way. Model 3 improved ELPD by 0.92, with an SE of 3.38. No Model 3 observation had Pareto $k>0.70$; Model 2 had five, and neither model had $k>1$.
