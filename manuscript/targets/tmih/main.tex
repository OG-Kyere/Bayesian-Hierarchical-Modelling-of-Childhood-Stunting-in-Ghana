...
\author{Gideon Ofosu Kyere, BSc\\\small Independent Researcher, Ghana\\\small ORCID: 0009-0003-9848-8437\\\small Correspondence: 47 Mempeasem ST, GA-485-2566; kyereofosu2003@gmail.com}
\date{}
\begin{document}
\maketitle

\begin{abstract}
\noindent\textbf{Objectives:} To quantify residual household- and community-level heterogeneity in childhood stunting in Ghana and assess whether the pattern persisted after accounting for water, sanitation, maternal education, and core sociodemographic characteristics.

\noindent\textbf{Methods:} We conducted a cross-sectional secondary analysis of the 2022 Ghana Demographic and Health Survey including 4,928 children aged 0--59 months in 3,545 households and 616 survey communities. Survey-weighted prevalence was estimated using the DHS design. Bayesian hierarchical logistic models included household and community random intercepts. The final model was evaluated with eight chains and was challenged through alternative priors, survey-weight sensitivity, missing-data treatment, spline age specification, detailed WASH coding, posterior predictive checks, PSIS-LOO, and independent GEE analyses.

\noindent\textbf{Results:} Survey-weighted stunting prevalence was 17.4\% (95\% CI 15.8--18.9). In the final model, the household SD was 1.23 and the community SD 0.39; the corresponding household VPC and community ICC were 0.31 and 0.03. Boys had higher odds of stunting than girls (OR 1.50, 95\% posterior interval 1.24--1.82), as did children aged 24--35 versus 0--5 months (OR 2.91, 2.06--4.21). Unimproved drinking-water source had OR 1.50 (1.15--1.99), whereas higher maternal education had OR 0.37 (0.20--0.65). Sensitivity analyses preserved the main household-versus-community pattern.

\noindent\textbf{Conclusions:} Residual clustering of childhood stunting in these data was concentrated more strongly at the household than the survey-community level. The findings are observational and support further study of household conditions not captured by standard DHS covariates.
\end{abstract}
...
Previous work in Ghana has already shown that stunting has socioeconomic, household, and spatial structure. Bayesian geostatistical studies have described geographical variation \citep{AhetoDagne2021,AmoakoJohnson2022}, while multilevel analyses have identified household and socioeconomic correlates \citep{AhetoEtAl2015,IddrisuGyabaah2023}. Recent regional evidence from 35 sub-Saharan African countries continues to show strong patterning by age, sex, maternal education, wealth, and contextual conditions \citep{MoloroEtAl2026}, and a 2026 systematic review found that WASH--stunting associations vary appreciably across exposure definitions and settings \citep{WijayantoEtAl2026}. Work using the 2022 GDHS has also examined WASH and child nutrition among children born to young mothers \citep{OgumEtAl2026}. Our contribution is therefore not Bayesian modelling by itself. We use the latest GDHS to separate household from community heterogeneity in the full eligible under-five sample and ask whether that decomposition changes after WASH and maternal education are added.
...
Gideon Ofosu Kyere: Conceptualization; Data curation; Formal analysis; Investigation; Methodology; Software; Validation; Visualization; Writing -- original draft; Writing -- review \& editing; Project administration. The author list and contribution statement should be revisited if additional qualifying contributors are added before submission.

\section*{Editorial Information (for submission only)}
\noindent\textbf{Main-body word count:} approximately 2870 words.

\noindent\textbf{Suggested reviewers:}
\begin{enumerate}
\item Justice Moses K. Aheto, University of Ghana School of Public Health --- \nolinkurl{jmkaheto@ug.edu.gh}
\item Richmond N. O. Aryeetey, University of Ghana School of Public Health --- \nolinkurl{raryeetey@ug.edu.gh}
\item Amos Laar, University of Ghana School of Public Health --- \nolinkurl{alaar@ug.edu.gh}
\item Duah Dwomoh, University of Ghana School of Public Health --- \nolinkurl{duahdwomoh@ug.edu.gh}
\item Fusta Azupogo, University for Development Studies --- \nolinkurl{fazupoko@uds.edu.gh}
\end{enumerate}
Reviewer suggestions are provisional and should be checked for recent collaboration, supervisory relationships, institutional conflicts, or other competing interests before submission.
