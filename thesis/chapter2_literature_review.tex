...
For this reason, the present study separates the goals of national description and hierarchical association modelling. Survey-weighted estimates will be used where appropriate for population description, while the primary Bayesian models will explicitly represent household and community clustering. Alternative treatments of survey weights will then be examined as sensitivity analyses rather than assumed to be inconsequential. The objective is to determine whether the substantive posterior conclusions depend materially on the handling of the sampling design.
