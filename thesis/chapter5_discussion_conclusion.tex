...
All principal Model 1--3 fits had zero divergent transitions and fixed-effect parameters showed good chain agreement. However, the household and community standard deviations mixed more slowly, particularly in the harmonized WASH and maternal-education models. The current estimates are sufficient to establish the broad contrast between household and community heterogeneity, but the exact variance-component intervals will be regenerated using longer production runs before final submission and publication.
