...
This chapter presents the empirical findings from the 2022 Ghana Demographic and Health Survey. It begins with the construction of the analytic sample and survey-weighted descriptive patterns of childhood stunting, followed by the sequential Bayesian hierarchical models. The chapter also reports prior-sensitivity and survey-weight sensitivity analyses. Predictive model comparison and expanded posterior predictive checking remain part of the final production analysis.
...
The current results constitute the principal inferential analysis, but they are not yet the final locked publication analysis. Before thesis submission, the hierarchical variance parameters will be confirmed with longer production runs in a stable computational environment. Expanded posterior predictive checks and a predictive model-comparison analysis will also be generated from those final saved posterior objects.
