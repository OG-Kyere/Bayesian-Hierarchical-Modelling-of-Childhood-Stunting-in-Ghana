...
The sanitation estimate remained comparatively uncertain under all prior choices. These results indicate that the main substantive conclusions concerning unimproved water and higher maternal education are not artifacts of the primary prior scale. The hierarchical variance parameters were more sensitive and mixed more slowly under the alternative priors; therefore, the prior-sensitivity analysis is used primarily to assess robustness of the substantive fixed effects rather than to replace the primary variance decomposition.
