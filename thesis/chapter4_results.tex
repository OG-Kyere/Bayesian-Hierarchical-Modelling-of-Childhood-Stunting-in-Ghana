...
The current results are exploratory and do not constitute the final publication analysis. Before thesis submission, the hierarchical variance parameters will be confirmed with longer production runs in a stable computational environment. The existing posterior predictive checks and predictive model comparison will then be regenerated from the final locked posterior objects to ensure that the reported publication tables and figures correspond exactly to the production fits.
